...
class StandardPass : public ShaderPass
{
...
public:
	...
	StandardPass() :
		...
		property({ {1,1,1,1},{ 0,0,0,0 } })
	{
		shaderPath = L"Engine/Shaders/StandardShaders.hlsl";
	...
	void SetBuffer() override
	{
		...
		constantBuffer.SetConstantBufferView(TODO, 3);
	}
};
